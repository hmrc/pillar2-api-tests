...
Feature: UKTR and BTN Scenarios
  ...
  Scenario Outline: verify submit UKTR response
    ...
    Examples:
      ...
      | Organisation | 401        | XEPLR0000000400 | jsonSchema/uktrSchema/Response/UKTR_Error_Response.json | Submission Api | uk-tax-return |
      | Individual   | 403        | XEPLR0000000400 | jsonSchema/uktrSchema/Response/UKTR_Error_Response.json | Submission Api | uk-tax-return |
  ...
  Scenario Outline: verify amend UKTR response
    ...
    Examples:
      ...
      | Organisation | 401        | XEPLR0000000400 | jsonSchema/uktrSchema/Response/UKTR_Error_Response.json | Amend UKTR | uk-tax-return |
      | Individual   | 403        | XEPLR0000000400 | jsonSchema/uktrSchema/Response/UKTR_Error_Response.json | Amend UKTR | uk-tax-return |
  ...
  Scenario Outline: verify submit UKTR nil return response
    ...
    Examples:
      ...
      | Organisation | 401        | XEPLR0000000400 | jsonSchema/uktrSchema/Response/UKTR_Error_Response.json | Submission Nil Return Api | uk-tax-return |
      | Individual   | 403        | XEPLR0000000400 | jsonSchema/uktrSchema/Response/UKTR_Error_Response.json | Submission Nil Return Api | uk-tax-return |
  ...
  Scenario Outline: verify submission api for BTN
    ...
    Examples:
      ...
      | Organisation | 401        | XEPLR0000000400 | jsonSchema/uktrSchema/Response/UKTR_Error_Response.json | Submission Api BTN | below-threshold-notification |
      | Individual   | 403        | XEPLR0000000400 | jsonSchema/uktrSchema/Response/UKTR_Error_Response.json | Submission Api BTN | below-threshold-notification |
  ...
  Scenario Outline: verify submission api for agent
    ...
    Examples:
      ...
      | Agent      | 401        | XEPLR0000000400 | jsonSchema/uktrSchema/Response/UKTR_Error_Response.json | Submission Api | uk-tax-return |
      | Individual | 403        | XEPLR0000000400 | jsonSchema/uktrSchema/Response/UKTR_Error_Response.json | Submission Api | uk-tax-return |