...
Feature: Validate BTN Json schema and Responses
  ...
  Scenario Outline: Verify Submit BTN responses and validate schema
    ...
    Then I validate request json schema for "SubmissionApiBTN_Request"
    ...
    Examples:
      ...
      | Organisation | 500        | XEPLR0123456500 | UKTR_Error_Response | Submission Api BTN | below-threshold-notification |
      | Organisation | 400        | XEPLR0000000400 | UKTR_Error_Response | Submission Api BTN | below-threshold-notification |
      | Organisation | 401        | XEPLR0000000400 | UKTR_Error_Response | Submission Api BTN | below-threshold-notification |
      | Individual   | 403        | XEPLR0000000400 | UKTR_Error_Response | Submission Api BTN | below-threshold-notification |
